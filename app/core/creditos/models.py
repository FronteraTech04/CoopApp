...
class SocioDetalleSolicitud(BaseModel):
    socio = models.ForeignKey(Socio, on_delete=models.CASCADE, null=True, blank=True, related_name='Socio')
...
class DetalleSolicitud(BaseModel):
    socio_detalle_solicitud = models.ForeignKey(SocioDetalleSolicitud, on_delete=models.CASCADE, null=True, blank=True, related_name='SocioDetalleSolicitud')
