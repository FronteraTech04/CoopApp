    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numero_identificacion', models.CharField(db_index=True, max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('segundo_nombre', models.CharField(max_length=50)),
                ('fecha_nacimiento', models.DateField()),
                ('tipo_identificacion', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Tipo_identificacion', to='common.tipoidentificacion')),
            ],
            options={
